...
@EnableWebSecurity // Cho phép @PreAuthorize, @Secured
public class SecurityConfig {
    private final MUserService userDetailsService;
    private final Filter jwtAuthFilter; // Filter custom kiểm tra JWT
